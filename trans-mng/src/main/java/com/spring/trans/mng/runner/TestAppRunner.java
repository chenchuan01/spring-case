package com.spring.trans.mng.runner;
...
import com.spring.trans.mng.serv.BookingService;

/**
 *                       
 * @Filename TestAppRunner.java
 *
 * @Description 
 *
 * @Version 1.0
...
public class TestAppRunner implements CommandLineRunner {
	private static final Logger logger = LoggerFactory.getLogger(TestAppRunner.class);
	
	private final BookingService bookingService;
	
	public TestAppRunner(BookingService bookingService) {
